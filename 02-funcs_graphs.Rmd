...
```{r, x2m1Inv, echo=FALSE, fig.cap="The function $g(x)=x^2-1$ (red curve) and its partial inverse $g^{-1}(x)=\\sqrt{x+1}$ (blue curve) together with the line of symmetry $y=x$. <a href="https://www.desmos.com/calculator/l763j7dm90" target="_blank">[Open graph in new browser tab.]</a>"}
...
```{r, RationalInv, echo=FALSE, fig.cap="The function $h(x)=\\dfrac{x-2}{x-3}$ (red curve) and its partial inverse $h^{-1}(x)=\\dfrac{3x-2}{x-1}$ (blue curve) together with the line of symmetry $y=x$. <a href="https://www.desmos.com/calculator/wsktzns4ca" target="_blank">[Open graph in new browser tab.]</a>"}
...
```{r, cuberoots, echo=FALSE, fig.cap="The functions $f(x)=x^3$ (red curve) $g(x)=x^{1/3}$ (blue curve) are reflections of each other in the line $y=x$ (dashed black line) for all values of $x$. <a href="https://www.desmos.com/calculator/exmc148194" target="_blank">[Open graph in new browser tab.]</a>"}

...
There is a special value of the base $a$ for which the constant of proportionality is $k=1$. This is known as Euler's number^[Named after the Swiss mathematician [Leonhard Euler](https://en.wikipedia.org/wiki/Leonhard_Euler), an extraordinarily prolific mathematician even after losing his sight. Indeed, when discussing his blindness, Euler is reported to have said ``Now I will have fewer distractions'' [@Eves, p. 48].] and is denoted as $e$. It is an irrational number (has an infinitely long, never repeating decimal expansion):
...
2. Rearrange $y=f(x)$ to give $x$ in terms of $y$;
3. Interchange the variable labels $x$ and $y$ to obtain $y=f^{-1}(x)$.

Let's take a look at some examples.

::: {.example #AlgebraicInverses}

1. Find the inverse of $f(x)=2x+1$.

This function is one-to-one. Rearranging for $x$
...
It is important to keep these facts in mind when rearranging equations. For example, consider the equation of the area $A$ of a circle of radius $r$:

$$A=\pi r^2.$$

To find the radius as a function of area, we first rearrange to give

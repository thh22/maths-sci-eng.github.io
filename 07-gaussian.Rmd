...
1. select the first non-zero entry in the top row as a pivot (if this row is non-zero);
...
1. select the final non-zero entry in the final row of the matrix of coefficients as the pivot (if this row is non-zero);
1. scale this row to set the value of the pivot to one;
1. perform EROs to eliminate the entries above the pivot;
1. move to the row above and continue the process (from step 4 onwards);

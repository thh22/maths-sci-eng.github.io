...
$$x=1+4y.$$
It does not matter which equation we choose first or which variable we choose first, this choice was just easier to re-arrange. We can then substitute this back in for $x$ in the first equation:
$$3(1+4y)+2y=5$$
...
1. $2x+6<18.$
    ...
    Here we can easily re-arrange the inequality (subtract $6$ from each side and divide by the positive number $2$ -- which preserves the direction of the inequality). This gives
    $$x<6.$$
